...
| Monitoring + analytics | ✅ | Sentry (`@sentry/nextjs`) + Vercel Analytics (`web/app/layout.tsx`) |
...
| Screenshots (UI, mobile, analytics) | 🟡 | Drop into [docs/screenshots/](docs/screenshots/) — filenames listed there |
...
2. **Capture screenshots** — the set in [docs/screenshots/README.md](docs/screenshots/README.md),
   including a mobile viewport and the Vercel Analytics / Sentry dashboards.
3. **Record the demo video** — follow the script in [DEMO.md](DEMO.md); show a
   real Freighter signature and the stellar.expert tx page. Paste the link here.
4. **Collect feedback** — get onboarded users to use the 💬 widget; summarise in
